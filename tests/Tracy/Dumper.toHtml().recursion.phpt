...
<span class="tracy-dump-indent">   </span><span class="tracy-dump-public">y</span> => <span class="tracy-dump-number">2</span>
<span class="tracy-dump-indent">   </span><span class="tracy-dump-public">z</span> => <span class="tracy-dump-hash">&1</span> <span class="tracy-dump-object">stdClass</span> <span class="tracy-dump-hash">#%d%</span> { <i>RECURSION</i> }
