...
DOMDocument #%d%
   ...
   |  baseURI: null
   |  childNodes: DOMNodeList #%d% ...
   |  firstChild: DOMElement #%d% ...
   |  lastChild: DOMElement #%d% ...
   |  localName: 'html'
   |  namespaceURI: null
   |  nextSibling: null
   |  nodeName: 'html'
   ...
   |  parentNode: DOMDocument #%d% RECURSION
   |  prefix: ''
   |  previousSibling: DOMDocumentType #%d% see above
   |  schemaTypeInfo: null
   |  tagName: 'html'
   |  textContent: 'Ahoj'
   documentURI: null
   encoding: null
   firstChild: DOMDocumentType #%d% see above
   formatOutput: false
   implementation: DOMImplementation #%d%
   lastChild: DOMElement #%d% see above
   localName: null
   namespaceURI: null
   nextSibling: null
   nodeName: '#document'
