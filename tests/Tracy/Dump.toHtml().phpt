...
Assert::match( '<pre class="nette-dump"><span class="nette-toggle"><span class="nette-dump-array">array</span> (5)</span> <code>[
   ...
   <span class="nette-dump-key">4</span> => <span class="nette-toggle-collapsed"><span class="nette-dump-array">array</span> (7)</span> <code class="nette-collapsed">{
      ...
      <span class="nette-dump-key">3</span> => <span class="nette-dump-number">3</span>
      <span class="nette-dump-key">4</span> => <span class="nette-dump-number">4</span>
      <span class="nette-dump-key">5</span> => <span class="nette-dump-number">5</span>
      <span class="nette-dump-key">6</span> => <span class="nette-dump-number">6</span>
      <span class="nette-dump-key">7</span> => <span class="nette-dump-number">7</span>
   }</code>
]</code>
</pre>
', Dump::toHtml(array(1, 'hello', array(), array(1, 2), array(1 => 1, 2, 3, 4, 5, 6, 7))) );
...
</pre>', Dump::toHtml(fopen(__FILE__, 'r')) );

Assert::match( '<pre class="nette-dump"><span class="nette-dump-object">stdClass</span> (0)
</pre>', Dump::toHtml((object) NULL) );

Assert::match( '<pre class="nette-dump"><span class="nette-toggle"><span class="nette-dump-object">Test</span> (3)</span> <code>{
   <span class="nette-dump-key">x</span> => <span class="nette-toggle"><span class="nette-dump-array">array</span> (2)</span> <code>[
      <span class="nette-dump-key">0</span> => <span class="nette-dump-number">10</span>
      <span class="nette-dump-key">1</span> => <span class="nette-dump-null">NULL</span>
   ]</code>
   <span class="nette-dump-key">y</span> <span class="nette-dump-visibility">private</span> => <span class="nette-dump-string">"hello"</span> (5)
   <span class="nette-dump-key">z</span> <span class="nette-dump-visibility">protected</span> => <span class="nette-dump-number">30.0</span>
}</code>
</pre>', Dump::toHtml(new Test) );

Assert::match( '<pre class="nette-dump"><span class="nette-toggle-collapsed"><span class="nette-dump-object">Test</span> (3)</span> <code class="nette-collapsed">{
   <span class="nette-dump-key">x</span> => <span class="nette-toggle-collapsed"><span class="nette-dump-array">array</span> (2)</span> <code class="nette-collapsed">[
      <span class="nette-dump-key">0</span> => <span class="nette-dump-number">10</span>
      <span class="nette-dump-key">1</span> => <span class="nette-dump-null">NULL</span>
   ]</code>
   <span class="nette-dump-key">y</span> <span class="nette-dump-visibility">private</span> => <span class="nette-dump-string">"hello"</span> (5)
...
</pre>', Dump::toHtml(new Test, array(Dump::COLLAPSE => 1)) );
