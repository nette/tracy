...
in file %a% on line %d%
Ctrl-Click to open in editor" data-tracy-href="editor:%a%"><span class="tracy-dump-object">Test</span> <span class="tracy-dump-hash">#%d%</span>
</pre>
', Dumper::toHtml(new Test, ['location' => Dumper::LOCATION_SOURCE]));


Assert::match('<pre class="tracy-dump"><span class="tracy-dump-object" title="Declared in file %a% on line %d%
Ctrl-Click to open in editor" data-tracy-href="editor:%a%">Test</span> <span class="tracy-dump-hash">#%d%</span>
</pre>
', Dumper::toHtml(new Test, ['location' => Dumper::LOCATION_CLASS]));


Assert::match('<pre class="tracy-dump" title="Dumper::toHtml(new Test, [&#039;location&#039; =&gt; Dumper::LOCATION_LINK | Dumper::LOCATION_CLASS]))
in file %a% on line %d%
Ctrl-Click to open in editor" data-tracy-href="editor:%a%"><span class="tracy-dump-object" title="Declared in file %a% on line %d%
Ctrl-Click to open in editor" data-tracy-href="editor:%a%">Test</span> <span class="tracy-dump-hash">#%d%</span>
<small>in <a href="editor:%a%">%a%:%d%</a></small></pre>
