...
$f = fopen(__FILE__, 'r');
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-toggle tracy-collapsed"><span class="tracy-dump-resource">stream resource</span> <span class="tracy-dump-hash">@%d%</span></span>
...
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-toggle"><span class="tracy-dump-object" title="Declared in file %a% on line %d%
...
Assert::match(<<<'XX'
<pre class="tracy-dump--light" data-tracy-snapshot='[]'><span class="tracy-toggle"><span class="tracy-dump-object">Closure($x, $y)</span> <span class="tracy-dump-hash">#%d%</span></span>
...
// SplFileInfo
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-toggle"><span class="tracy-dump-object">SplFileInfo</span> <span class="tracy-dump-hash">#%d%</span></span>
...
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-toggle"><span class="tracy-dump-object">SplObjectStorage</span> <span class="tracy-dump-hash">#%d%</span></span>
...
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-toggle"><span class="tracy-dump-object">ArrayObject</span> <span class="tracy-dump-hash">#%d%</span></span>
...
Assert::match(<<<'XX'
<pre class="tracy-dump--light"><span class="tracy-toggle"><span class="tracy-dump-object">ArrayObjectChild</span> <span class="tracy-dump-hash">#%d%</span></span>
