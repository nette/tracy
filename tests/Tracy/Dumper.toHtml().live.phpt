...
Assert::same( array(
	'01' => array('id' => '01', 'name' => 'stdClass', 'editor' => NULL, 'items' => array()),
	'02' => array('id' => '02', 'name' => 'stdClass', 'editor' => NULL, 'items' => array()),
...
in file %a% on line %d%" data-tracy-href="editor://open/?file=%a%&amp;line=%d%" data-tracy-dump=\'{"object":"01"}\'><small>in <a href="editor://open/?file=%a%&amp;line=%d%" title="%a%:%d%">%a%:%d%</a></small></pre>',
...
Assert::type( 'int', $data['01']['editor']['line'] );
Assert::type( 'string', $data['01']['editor']['url'] );
unset($data['01']['editor']['line'], $data['01']['editor']['url']);
