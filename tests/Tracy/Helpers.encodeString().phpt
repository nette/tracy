...
Assert::same('hell <span>…</span> ', Helpers::encodeString('hello', 4));

Assert::same('Iñtërnâtiônàlizætiøn', Helpers::encodeString("I\u{F1}t\u{EB}rn\u{E2}ti\u{F4}n\u{E0}liz\u{E6}ti\u{F8}n"));
Assert::same('Iñtër <span>…</span> ', Helpers::encodeString("I\u{F1}t\u{EB}rn\u{E2}ti\u{F4}n\u{E0}liz\u{E6}ti\u{F8}n", 5));

Assert::same('<span>\x00\x01</span>', Helpers::encodeString("\x00\x01"));
Assert::same('<span>\x00</span> <span>…</span> ', Helpers::encodeString("\x00\x01", 1));
