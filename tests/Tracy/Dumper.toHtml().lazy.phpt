...
$arr[] = &$arr;
Assert::match(
	'<pre class="tracy-dump" data-tracy-snapshot=\'[]\' data-tracy-dump=\'[[0,1],[1,2],[2,3],[3,[[0,1],[1,2],[2,3],[3,{"array":[],"stop":"r","length":4},1]],1]]\'></pre>',
...
$arr = [1, [2, [3, [4, [5, [6]]]]], 3];
Assert::match(
	'<pre class="tracy-dump" data-tracy-snapshot=\'[]\' data-tracy-dump=\'[[0,1],[1,[[0,2],[1,[[0,3],[1,[[0,4],[1,{"array":[],"stop":true,"length":2}]]]]]]],[2,3]]\'></pre>',
	Dumper::toHtml($arr, $options)
);
...
$arr = [1, 2, 3, 4, 5, 6, 7, 8];
Assert::match(
	'<pre class="tracy-dump" data-tracy-snapshot=\'{"%d%":{"name":"stdClass","items":[[0,1,3],[1,2,3],[2,3,3],[3,4,3],[4,5,3]],"cut":true}}\' data-tracy-dump=\'[[0,{"array":[[0,1],[1,2],[2,3],[3,4],[4,5]],"length":8,"cut":true}],[1,{"object":%d%}]]\'></pre>',
