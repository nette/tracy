...
Tracy 2.6-dev requires PHP version 7.1 or newer (supports PHP up to 7.3) and is compatible with Chrome 49+, Firefox 45+, MS Edge 12+, Safari 10+ and iOS Safari 10.2+.
